...
angular.module("uiFormat").directive("uiFormatNumber",function(){return{require:"ngModel",link:function(scope,element,attrs,ctrl){var _formatNumber=function(number){return void 0===number&&(number=""),number=number.toString().replace(/[^0-9]+/g,"")};ctrl.$formatters.push(function(value){return _formatNumber(value)}),element.bind("keyup",function(){ctrl.$setViewValue(_formatNumber(ctrl.$viewValue)),ctrl.$render()})}}});
